...
if __name__ == '__main__':
    songs_in_block_playlist = get_songs_of_block_playlist(client_id=SPOTIPY_CLIENT_ID,
                                                          client_secret=SPOTIPY_CLIENT_SECRET,
                                                          playlist_id=PLAYLIST_BLOCK_ID)
    new_song_ids = remove_listened_songs(songs_in_block_playlist=songs_in_block_playlist)
